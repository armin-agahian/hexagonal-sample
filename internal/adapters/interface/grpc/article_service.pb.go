...
var file_article_service_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x67, 0x72, 0x70, 0x63, 0x22, 0x43, 0x0a,
	...
	0x64, 0x79, 0x22, 0x38, 0x0a, 0x0d, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x12, 0x27, 0x0a, 0x07, 0x61, 0x72, 0x74, 0x69, 0x63, 0x6c, 0x65, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x0d, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x41, 0x72, 0x74, 0x69,
	0x63, 0x6c, 0x65, 0x52, 0x07, 0x61, 0x72, 0x74, 0x69, 0x63, 0x6c, 0x65, 0x22, 0x20, 0x0a, 0x0e,
	...
	0x07, 0x61, 0x72, 0x74, 0x69, 0x63, 0x6c, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0d,
	0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x41, 0x72, 0x74, 0x69, 0x63, 0x6c, 0x65, 0x52, 0x07, 0x61,
	0x72, 0x74, 0x69, 0x63, 0x6c, 0x65, 0x32, 0x74, 0x0a, 0x0e, 0x41, 0x72, 0x74, 0x69, 0x63, 0x6c,
	...
	0x04, 0x52, 0x65, 0x61, 0x64, 0x12, 0x11, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x52, 0x65, 0x61,
	0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x12, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e,
	0x52, 0x65, 0x61, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x04, 0x5a, 0x02,
...
var file_article_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_article_service_proto_goTypes = []interface{}{
	(*Article)(nil),        // 0: grpc.Article
	(*CreateRequest)(nil),  // 1: grpc.CreateRequest
	(*CreateResponse)(nil), // 2: grpc.CreateResponse
	(*ReadRequest)(nil),    // 3: grpc.ReadRequest
	(*ReadResponse)(nil),   // 4: grpc.ReadResponse
}
var file_article_service_proto_depIdxs = []int32{
	0, // 0: grpc.CreateRequest.article:type_name -> grpc.Article
	0, // 1: grpc.ReadResponse.article:type_name -> grpc.Article
	1, // 2: grpc.ArticleService.Create:input_type -> grpc.CreateRequest
	3, // 3: grpc.ArticleService.Read:input_type -> grpc.ReadRequest
	2, // 4: grpc.ArticleService.Create:output_type -> grpc.CreateResponse
	4, // 5: grpc.ArticleService.Read:output_type -> grpc.ReadResponse
